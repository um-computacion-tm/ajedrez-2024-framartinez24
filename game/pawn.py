...
#pawn has too many movements to program
    def get_moves_pawn(self, board, from_row, from_col):
        ...
        moves.extend(self.pawn_moves(board, from_row, from_col, direction))
        moves.extend(self.diagonally_take(board, from_row, from_col, direction))
        return moves

    def pawn_moves(self, board, from_row, from_col, direction): 
        moves = []
    ...
    def pawn_move(self, board, from_row, from_col, to_row, to_col):
